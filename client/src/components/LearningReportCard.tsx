 ...
 * Parchment background with gold border, ornate section headers
 */

import { motion } from "framer-motion";
import { BookOpen, Clock, Target, Brain, TrendingUp, TrendingDown } from "lucide-react";
import {
  RadarChart,
  PolarGrid,
  PolarAngleAxis,
      ...
      <div className="flex-1 min-h-[180px] max-h-[220px] mb-3">
        <ResponsiveContainer width="100%" height="100%">
          <RadarChart data={radarData} cx="50%" cy="50%" outerRadius="68%">
            ...
            <PolarAngleAxis
              dataKey="subject"
              tick={{ fill: "#5A4A3A", fontSize: 11, fontWeight: 500 }}
            />
            <Radar
              name="スコア"
              dataKey="score"
